...
ggplot(clean_EDtranscomp_survey, aes(x=EDtranscomp)) + geom_bar()
```
...
ggplot(clean_attraction_survey, aes(x=attraction, fill=ED_BIN)) + geom_bar()
```
...
ggplot(clean_stress_survey, aes(x=nonaffirm, fill = DE_BIN)) + geom_bar() + theme(axis.text.x=element_text(angle = -90, hjust = 0))
